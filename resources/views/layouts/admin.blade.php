					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									<a href="#"><i class="icon-bag fill"></i> <span>Manajemen Produk</span></a>
								</li>
								<li>
									<a href="#"><i class="icon-glyphicon glyphicon-euro"></i> <span>Manajemen Keuangan</span></a>
								</li>
								<li>
									<a href="#"><i class="icon-person fill "></i> <span>Manajemen Koki</span></a>
								</li>
								<li>
									<a href="#"><i class="icon-people"></i> <span>Manajemen Pegawai</span></a>
								</li>
								<!-- /main -->
